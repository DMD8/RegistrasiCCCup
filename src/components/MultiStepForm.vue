  ...
  export default {
    data: () => {
      return {
        ...
        formSteps: [
          {
            title: "Registrasi CC Cup XXXV",
            fields: [
              { label: "Masukkan Nama", value: '', valid: true, pattern: /.+/ },
              { label: "Asal Sekolah", value: '', valid: true, pattern: /.+/ }
            ]
          },
          {
...
<style lang="scss" scoped>
  ...
  article {
    ...
    header {
      ...
      border-right: 2px dotted rgb(139, 67, 41);
